...
CREATE DATABASE IF NOT EXISTS `tiberman_tracking` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE IF NOT EXISTS `audit_logs` (
  ...
  `meta` longtext CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL CHECK (json_valid(`meta`)),
...
CREATE TABLE IF NOT EXISTS `shipments` (
  ...
  `barcode_data` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `status` enum('draft','assigned','on_progress','delivered','cancelled') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'draft',
...
CREATE TABLE IF NOT EXISTS `tracking_points` (
  ...
  `source` enum('GPS','QR_SCAN','MANUAL','IP_LOOKUP') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'GPS',
  `ip_address` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `ip_geo` longtext CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL CHECK (json_valid(`ip_geo`)),
  `device_info` longtext CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL CHECK (json_valid(`device_info`)),
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `role` enum('creator','admin','view_only','superuser') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'creator',
